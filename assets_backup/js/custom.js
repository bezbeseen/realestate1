...
(function($) {
  ...
  $(document).ready(function () {
    // Delegated handler for opening the mobile menu
    $(document).on('click', '.mobile_menu_btn', function () {
      $('.sidebar_mobile_menu').addClass('active');
      // Make sure to target the overlay within the mobile menu's wrapper
      $('.sidebar-menu-wrapper .overlay').addClass('active'); 
    });

    // Delegated handler for closing the mobile menu 
    // (targets the close button and overlay specifically within .sidebar-menu-wrapper)
    $(document).on('click', '.sidebar-menu-wrapper .close_btn, .sidebar-menu-wrapper .overlay', function () {
